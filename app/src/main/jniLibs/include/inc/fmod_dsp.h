...
/* 
    DSP callbacks
*/
typedef FMOD_RESULT (F_CALLBACK
...
FMOD_DSP_STATE *dsp_state,
unsigned int length,
const FMOD_DSP_BUFFER_ARRAY *inbufferarray, FMOD_DSP_BUFFER_ARRAY
*outbufferarray,
FMOD_BOOL inputsidle, FMOD_DSP_PROCESS_OPERATION
op);
typedef FMOD_RESULT (F_CALLBACK
...
FMOD_DSP_STATE *dsp_state, FMOD_BOOL
inputsidle,
...
typedef FMOD_RESULT (F_CALLBACK
*FMOD_DSP_SYSTEM_GETSAMPLERATE)         (
FMOD_DSP_STATE *dsp_state,
int *rate
);
typedef FMOD_RESULT (F_CALLBACK
*FMOD_DSP_SYSTEM_GETBLOCKSIZE)          (
FMOD_DSP_STATE *dsp_state,
unsigned int *blocksize
);
typedef FMOD_RESULT (F_CALLBACK
*FMOD_DSP_SYSTEM_GETSPEAKERMODE)        (
FMOD_DSP_STATE *dsp_state, FMOD_SPEAKERMODE
*speakermode_mixer,
...
FMOD_DSP_STATE *thisdsp,
int size,
const float *signal, FMOD_COMPLEX
* dft,
const float *window,
int signalhop
);
...
typedef FMOD_RESULT (F_CALLBACK
*FMOD_DSP_PAN_SUM_STEREO_MATRIX)            (
FMOD_DSP_STATE *dsp_state,
int sourceSpeakerMode,
float pan,
float lowFrequencyGain,
...
typedef FMOD_RESULT (F_CALLBACK
*FMOD_DSP_PAN_SUM_SURROUND_MATRIX)          (
FMOD_DSP_STATE *dsp_state,
int sourceSpeakerMode,
...
float overallGain,
int matrixHop,
float *matrix, FMOD_DSP_PAN_SURROUND_FLAGS
flags);
typedef FMOD_RESULT (F_CALLBACK
*FMOD_DSP_PAN_SUM_MONO_TO_SURROUND_MATRIX)  (
FMOD_DSP_STATE *dsp_state,
int targetSpeakerMode,
float direction,
float extent,
...
typedef FMOD_RESULT (F_CALLBACK
*FMOD_DSP_PAN_SUM_STEREO_TO_SURROUND_MATRIX)(
FMOD_DSP_STATE *dsp_state,
int targetSpeakerMode,
float direction,
float extent,
...
typedef FMOD_RESULT (F_CALLBACK
*FMOD_DSP_PAN_3D_GET_ROLLOFF_GAIN)          (
